...
router.patch("/confirm-cleaning-request/:request", authorize(["A","L"]), confirmCleaningRequest);
router.patch("/refuse-cleaning-request/:request", authorize(["A","L"]), refuseCleaningRequest);
